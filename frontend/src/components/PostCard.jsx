...
const PostCard = ({ post,editHandle , deleteAPI }) => {
  ...
  const handleEdit = async (editId,text,media)=>
  {
        ...
        <div className="flex items-start px-4 py-6">
          ...
          <div>
            ...
            <div className="flex items-center space-x-4 mt-4">
              <CiEdit className="text-blue-500 cursor-pointer hover:text-blue-600 mr-24"
              onClick={()=>handleEdit(post._id,post.text,post.media)}
               size={20} />
              <MdDeleteOutline className="text-red-500 cursor-pointer hover:text-red-600"
